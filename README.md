...
> Dakar · Basket · Culture. Registration, CRM, ticketing & check-in for the Courtfest street basketball events in Dakar. Next main event: **Courtfest Dakar 2026, Sunday 01·11·2026** (all day; venue to be fixed). Founding edition: Place de l'Indépendance, 08·06·2026.
...
- `/register` player registration by category (rosters, `register_player` RPC) · `/register/equipe` team registration · `/buy` tickets · `/ticket/:token` public ticket
